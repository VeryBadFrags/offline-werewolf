...
const vilRoles = [
    { name: "🕵️ Detective", team: "villagers", verb: "Inspect", description: "Action: Find the alignement of a player", id: "detective" },
    ...
    { name: "🧙 Fortune Teller", team: "villagers", verb: "Guess role", description: "Action: Guess the role of a player", id: "teller" },
    ...
    { name: "🤡 Jester", team: "special", verb: "Do nothing", description: "Action: Troll someone anonymously<br>Win: Get yourself exiled (You also win with the Villagers)", id: "jester" }];
