...
{ name: "😈 Cultist", team: "werewolves", verb: "Threaten", description: "Action: Threaten someone during the night", id: "cultist" }];
const vilRoles = [
    ...
    { name: "🤡 Jester", team: "special", verb: "Visit", description: "Action: Visit someone (and do nothing)<br>Win: Get yourself exiled (You lose otherwise)", id: "jester" }];
