...
const vilRoles = [
    ...
    { name: "🤴 Mayor", team: "villagers", verb: "None", description: "Action: Impress someone - They will know your identity<br>Your vote counts twice" },
    { name: "🤡 Jester", team: "special", verb: "Troll", description: "Action: Troll someone anonymously<br>Win: Get yourself exiled (You also win with the Villagers)" }];
